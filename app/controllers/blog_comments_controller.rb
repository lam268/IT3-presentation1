  ...
  def create
    ...
    respond_to do |format|
      if @blog_comment.save
        new_url = "/blogs/" + @blog_comment.blog_id.to_s
        # format.html { redirect_to @blog_comment, notice: 'Blog comment was successfully created.' }
        format.html { redirect_to new_url, notice: 'Blog comment was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @blog_comment.update(blog_comment_params)
        new_url = "/blogs/" + @blog_comment.blog_id.to_s
        format.html { redirect_to new_url, notice: 'Blog comment was successfully updated.' }
